...
public class MapMethodsGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var endpoints = context.SyntaxProvider
            .CreateSyntaxProvider(predicate: (node, _) => node is ClassDeclarationSyntax, transform: SyntaxProviderTransformer)
    ...
    private static void SourceOutputAction(SourceProductionContext context, ImmutableArray<EndpointClassInformation> endpoints)
    {
        ...
        foreach (var (methods, implementsRegisterMethod, implementsConfigureMethod) in endpoints)
        {
            ...
            MapMethods(strBuilder, methods, implementsConfigureMethod, containingType);
        ...
        context.AddSource("Endpoints.g.cs", $$"""
            ...
            namespace ConsoleApp
            {
                public static partial class Program
                {
                    ...
                    public static partial global::Microsoft.AspNetCore.Routing.IEndpointRouteBuilder MapEndpointMapperEndpoints(this global::Microsoft.AspNetCore.Routing.IEndpointRouteBuilder builder)
                    {
            {{strBuilder}}
                        return builder;
                    }
